...
public class FamilyFilter extends CompareFilter {
    ...
    */
   public FamilyFilter(final CompareOp familyCompareOp, final WritableByteArrayComparable familyComparator) {
   ...
   public ReturnCode filterKeyValue(KeyValue v) {
      ...
      if (familyLength > 0) {
         if (doCompare(this.compareOp, this.comparator, v.getBuffer(), v.getFamilyOffset(), familyLength)) {
