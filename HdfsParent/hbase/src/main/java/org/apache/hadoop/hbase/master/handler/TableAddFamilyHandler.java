...
public class TableAddFamilyHandler extends TableEventHandler {
   ...
   public TableAddFamilyHandler(byte[] tableName, HColumnDescriptor familyDesc, Server server,
      ...
      if (htd.hasFamily(familyDesc.getName())) {
         throw new InvalidFamilyOperationException("Family '" + familyDesc.getNameAsString()
   ...
   protected void handleTableOperation(List<HRegionInfo> hris) throws IOException {
      ...
      HTableDescriptor htd = this.masterServices.getMasterFileSystem().addColumn(tableName, familyDesc);
