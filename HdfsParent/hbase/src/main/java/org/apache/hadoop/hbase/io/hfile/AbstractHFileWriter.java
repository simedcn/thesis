...
public abstract class AbstractHFileWriter extends SchemaConfigured implements HFile.Writer {
   ...
   public AbstractHFileWriter(CacheConfig cacheConf, FSDataOutputStream outputStream, Path path, int blockSize,
    ...
    */
   protected boolean checkKey(final byte[] key, final int offset, final int length) throws IOException {
   ...
   protected static FSDataOutputStream createOutputStream(Configuration conf, FileSystem fs, Path path)
         throws IOException {
