...
public class MasterStatusServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
      ...
      MasterStatusTmpl tmpl = new MasterStatusTmpl().setFrags(frags)
            .setShowAppendWarning(shouldShowAppendWarning(conf)).setRootLocation(rootLocation)
            .setMetaLocation(metaLocation).setServers(servers).setDeadServers(deadServers);
