...
public class MasterDumpServlet extends StateDumpServlet {
   ...
   private void dumpRIT(HMaster master, PrintWriter out) {
      NavigableMap<String, RegionState> regionsInTransition = master.getAssignmentManager().getRegionsInTransition();
   ...
   private void dumpServers(HMaster master, PrintWriter out) {
      Map<ServerName, HServerLoad> servers = master.getServerManager().getOnlineServers();
