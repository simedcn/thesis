...
public class HLogPrettyPrinter {
    ...
    */
   public HLogPrettyPrinter(boolean outputValues, boolean outputJSON, long sequence, String region, String row,
