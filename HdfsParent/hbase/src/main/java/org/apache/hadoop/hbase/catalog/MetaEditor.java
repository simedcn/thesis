...
public class MetaEditor {
    ...
    * @throws IOException
    */
   static void putToRootTable(final CatalogTracker ct, final Put p) throws IOException {
    ...
    * @throws IOException
    */
   static void putsToMetaTable(final CatalogTracker ct, final List<Put> ps) throws IOException {
    ...
    * @throws IOException
    */
   static void deleteMetaTable(final CatalogTracker ct, final Delete d) throws IOException {
      HTable t = MetaReader.getMetaHTable(ct);
      try {
         t.delete(d);
      } finally {
    ...
    * @throws IOException
    */
   public static void offlineParentInMeta(CatalogTracker catalogTracker, HRegionInfo parent, final HRegionInfo a,
         final HRegionInfo b) throws NotAllMetaRegionsOnlineException, IOException {
   ...
   public static void addDaughter(final CatalogTracker catalogTracker, final HRegionInfo regionInfo, final ServerName sn)
    ...
    * @throws IOException
    */
   public static void deleteDaughtersReferencesInParent(CatalogTracker catalogTracker, final HRegionInfo parent)
         throws NotAllMetaRegionsOnlineException, IOException {
      ...
      LOG.info("Deleted daughters references, qualifier=" + Bytes.toStringBinary(HConstants.SPLITA_QUALIFIER)
            + " and qualifier=" + Bytes.toStringBinary(HConstants.SPLITB_QUALIFIER) + ", from parent "
