...
public class CloseRootHandler extends CloseRegionHandler {
   ...
   public CloseRootHandler(final Server server, final RegionServerServices rsServices, HRegionInfo regionInfo) {
   ...
   public CloseRootHandler(final Server server, final RegionServerServices rsServices, HRegionInfo regionInfo,
      ...
      super(server, rsServices, regionInfo, abort, zk, versionOfClosingNode, EventType.M_RS_CLOSE_ROOT);
   }
}
