...
public class MasterMetrics implements Updater {
   ...
   /*
      ...
      */
   private final MetricsRate cluster_requests = new MetricsRate("cluster_requests", registry);

   /** Time it takes to finish HLog.splitLog() */
   final PersistentMetricsTimeVaryingRate splitTime = new PersistentMetricsTimeVaryingRate("splitTime", registry);

   /** Size of HLog files being split */
   final PersistentMetricsTimeVaryingRate splitSize = new PersistentMetricsTimeVaryingRate("splitSize", registry);
