...
public class SequenceFileLogReader implements HLog.Reader {
   ...
   static class WALReader extends SequenceFile.Reader {
      ...
      WALReader(final FileSystem fs, final Path p, final Configuration c) throws IOException {
         super(fs, p, c);
      }
      ...
      static class WALReaderFSDataInputStream extends FSDataInputStream {
         ...
         WALReaderFSDataInputStream(final FSDataInputStream is, final long l) throws IOException {
            super(is);
            this.length = l;
         }
         ...
         public long getPos() throws IOException {
            if (this.firstGetPosInvocation) {
               ...
               try {
                  ...
                  SequenceFileLogReader.LOG.warn("Error while trying to get accurate file length.  "
