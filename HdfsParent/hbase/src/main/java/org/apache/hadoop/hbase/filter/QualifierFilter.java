...
public class QualifierFilter extends CompareFilter {
    ...
    */
   public QualifierFilter(final CompareOp op, final WritableByteArrayComparable qualifierComparator) {
   ...
   public ReturnCode filterKeyValue(KeyValue v) {
      ...
      if (qualifierLength > 0) {
         if (doCompare(this.compareOp, this.comparator, v.getBuffer(), v.getQualifierOffset(), qualifierLength)) {
