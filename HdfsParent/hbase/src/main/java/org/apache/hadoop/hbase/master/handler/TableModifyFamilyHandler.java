...
public class TableModifyFamilyHandler extends TableEventHandler {
   ...
   public TableModifyFamilyHandler(byte[] tableName, HColumnDescriptor familyDesc, Server server,
   ...
   protected void handleTableOperation(List<HRegionInfo> regions) throws IOException {
      ...
      HTableDescriptor htd = this.masterServices.getMasterFileSystem().modifyColumn(tableName, familyDesc);
