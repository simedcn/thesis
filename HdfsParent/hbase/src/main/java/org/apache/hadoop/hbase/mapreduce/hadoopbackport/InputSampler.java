...
public class InputSampler<K, V> extends Configured implements Tool {
    ...
    * @throws IOException 
    */
   public static TaskAttemptContext getTaskAttemptContext(final Job job) throws IOException {
   ...
   public static <K, V> void writePartitionFile(Job job, Sampler<K, V> sampler) throws IOException,
