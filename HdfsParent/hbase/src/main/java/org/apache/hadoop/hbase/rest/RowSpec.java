...
public class RowSpec {
   ...
   private TreeSet<byte[]> columns = new TreeSet<byte[]>(Bytes.BYTES_COMPARATOR);
   ...
   public RowSpec(byte[] startRow, byte[] endRow, Collection<byte[]> columns, long startTime, long endTime,
         int maxVersions) {
      this.row = startRow;
      this.endRow = endRow;
      if (columns != null) {
