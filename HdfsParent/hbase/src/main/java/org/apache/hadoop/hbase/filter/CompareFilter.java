...
public abstract class CompareFilter extends FilterBase {
    ...
    */
   public CompareFilter(final CompareOp compareOp, final WritableByteArrayComparable comparator) {
   ...
   protected boolean doCompare(final CompareOp compareOp, final WritableByteArrayComparable comparator,
   ...
   public static ArrayList extractArguments(ArrayList<byte[]> filterArguments) {
      ...
      WritableByteArrayComparable comparator = ParseFilter.createComparator(ParseFilter
            .removeQuotesFromByteArray(filterArguments.get(1)));
   ...
   public void readFields(DataInput in) throws IOException {
      ...
      comparator = (WritableByteArrayComparable) HbaseObjectWritable.readObject(in, null);
   }
