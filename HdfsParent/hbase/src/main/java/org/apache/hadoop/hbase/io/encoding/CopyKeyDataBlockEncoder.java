...
public class CopyKeyDataBlockEncoder extends BufferedDataBlockEncoder {
   ...
   @Override
   public ByteBuffer uncompressKeyValues(DataInputStream source, int preserveHeaderLength, int skipLastBytes,
   ...
   public ByteBuffer getFirstKeyInBlock(ByteBuffer block) {
      ...
      return ByteBuffer.wrap(block.array(), block.arrayOffset() + 3 * Bytes.SIZEOF_INT, keyLength).slice();
   }
