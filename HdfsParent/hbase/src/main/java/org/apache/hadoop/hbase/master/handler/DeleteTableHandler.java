...
public class DeleteTableHandler extends TableEventHandler {
   ...
   public DeleteTableHandler(byte[] tableName, Server server, final MasterServices masterServices) throws IOException {
   ...
   protected void handleTableOperation(List<HRegionInfo> regions) throws IOException, KeeperException {
      ...
      for (HRegionInfo region : regions) {
         ...
         if (am.isRegionInTransition(region) != null) {
            throw new IOException("Waited hbase.master.wait.on.region (" + waitTime + "ms) for region to leave region "
