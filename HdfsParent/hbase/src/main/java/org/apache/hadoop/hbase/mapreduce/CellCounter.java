...
public class CellCounter {
      ...
      public void map(ImmutableBytesWritable row, Result values, Context context) throws IOException {
         ...
         try {
            ...
            for (KeyValue value : values.list()) {
               ...
               String thisRowQualifierName = thisRowFamilyName + separator + Bytes.toStringBinary(value.getQualifier());
   ...
   static class IntSumReducer<Key> extends Reducer<Key, IntWritable, Key, IntWritable> {
      ...
      public void reduce(Key key, Iterable<IntWritable> values, Context context) throws IOException,
