 ...
 */
public class HRegionInfo090x extends VersionedWritable implements WritableComparable<HRegionInfo090x> {
   ...
   public static final HRegionInfo090x ROOT_REGIONINFO = new HRegionInfo090x(0L, HTableDescriptor.ROOT_TABLEDESC);

   /** HRegionInfo for first meta region */
   public static final HRegionInfo090x FIRST_META_REGIONINFO = new HRegionInfo090x(1L, HTableDescriptor.META_TABLEDESC);
   ...
   private HRegionInfo090x(long regionId, HTableDescriptor tableDesc) {
      ...
      this.regionName = createRegionName(tableDesc.getName(), null, regionId, false);
    ...
    */
   public HRegionInfo090x(final HTableDescriptor tableDesc, final byte[] startKey, final byte[] endKey)
         throws IllegalArgumentException {
    ...
    * @throws IllegalArgumentException
    */
   public HRegionInfo090x(HTableDescriptor tableDesc, final byte[] startKey, final byte[] endKey, final boolean split)
         throws IllegalArgumentException {
    ...
    */
   public static byte[] createRegionName(final byte[] tableName, final byte[] startKey, final long regionid,
         boolean newFormat) {
    ...
    * @return Region name made of passed tableName, startKey and id
    */
   public static byte[] createRegionName(final byte[] tableName, final byte[] startKey, final String id,
         boolean newFormat) {
    ...
    * @return Region name made of passed tableName, startKey and id
    */
   public static byte[] createRegionName(final byte[] tableName, final byte[] startKey, final byte[] id,
         boolean newFormat) {
   ...
   public KVComparator getComparator() {
      return isRootRegion() ? KeyValue.ROOT_COMPARATOR : isMetaRegion() ? KeyValue.META_COMPARATOR
            : KeyValue.COMPARATOR;
   }
}
