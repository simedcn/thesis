...
public class HLogInputFormat extends InputFormat<HLogKey, WALEdit> {
   ...
   @Override
   public RecordReader<HLogKey, WALEdit> createRecordReader(InputSplit split, TaskAttemptContext context)
