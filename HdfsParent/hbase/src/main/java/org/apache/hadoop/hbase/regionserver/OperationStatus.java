...
public class OperationStatus {
   ...
   static final OperationStatus SUCCESS = new OperationStatus(OperationStatusCode.SUCCESS);

   /** Singleton for failed operations.  */
   static final OperationStatus FAILURE = new OperationStatus(OperationStatusCode.FAILURE);

   /** Singleton for operations not yet run.  */
   static final OperationStatus NOT_RUN = new OperationStatus(OperationStatusCode.NOT_RUN);
