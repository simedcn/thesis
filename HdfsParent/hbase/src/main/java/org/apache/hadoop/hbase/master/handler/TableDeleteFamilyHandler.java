...
public class TableDeleteFamilyHandler extends TableEventHandler {
   ...
   public TableDeleteFamilyHandler(byte[] tableName, byte[] familyName, Server server,
