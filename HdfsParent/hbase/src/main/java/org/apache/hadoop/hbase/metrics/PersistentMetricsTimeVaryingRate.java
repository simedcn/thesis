...
public class PersistentMetricsTimeVaryingRate extends MetricsTimeVaryingRate {
    ...
    */
   public PersistentMetricsTimeVaryingRate(final String nam, final MetricsRegistry registry, final String description) {
    ...
    * @param registry - where the metrics object will be registered
    */
   public PersistentMetricsTimeVaryingRate(final String nam, MetricsRegistry registry) {
