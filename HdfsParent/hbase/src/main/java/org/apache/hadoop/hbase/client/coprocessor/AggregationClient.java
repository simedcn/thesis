...
public class AggregationClient {
    ...
    *           & propagated to it.
    */
   public <R, S> R max(final byte[] tableName, final ColumnInterpreter<R, S> ci, final Scan scan) throws Throwable {
      ...
      try {
         ...
         table.coprocessorExec(AggregateProtocol.class, scan.getStartRow(), scan.getStopRow(),
               new Batch.Call<AggregateProtocol, R>() {
                  @Override
   ...
   private void validateParameters(Scan scan) throws IOException {
      if (scan == null
            || (Bytes.equals(scan.getStartRow(), scan.getStopRow()) && !Bytes.equals(scan.getStartRow(),
                  HConstants.EMPTY_START_ROW))
            || ((Bytes.compareTo(scan.getStartRow(), scan.getStopRow()) > 0) && !Bytes.equals(scan.getStopRow(),
    ...
    * @throws Throwable
    */
   public <R, S> R min(final byte[] tableName, final ColumnInterpreter<R, S> ci, final Scan scan) throws Throwable {
      validateParameters(scan);
    ...
    * @throws Throwable
    */
   public <R, S> long rowCount(final byte[] tableName, final ColumnInterpreter<R, S> ci, final Scan scan)
         throws Throwable {
      validateParameters(scan);
   ...
   public <R, S> S sum(final byte[] tableName, final ColumnInterpreter<R, S> ci, final Scan scan) throws Throwable {
      ...
      try {
         table = new HTable(conf, tableName);
         table.coprocessorExec(AggregateProtocol.class, scan.getStartRow(), scan.getStopRow(),
               new Batch.Call<AggregateProtocol, S>() {
                  @Override
    ...
    * @throws Throwable
    */
   private <R, S> Pair<S, Long> getAvgArgs(final byte[] tableName, final ColumnInterpreter<R, S> ci, final Scan scan)
         throws Throwable {
      validateParameters(scan);
    ...
    * @throws Throwable
    */
   public <R, S> double avg(final byte[] tableName, final ColumnInterpreter<R, S> ci, Scan scan) throws Throwable {
    ...
    * @throws Throwable
    */
   private <R, S> Pair<List<S>, Long> getStdArgs(final byte[] tableName, final ColumnInterpreter<R, S> ci,
    ...
    * @throws Throwable
    */
   public <R, S> double std(final byte[] tableName, ColumnInterpreter<R, S> ci, Scan scan) throws Throwable {
    ...
    * @throws Throwable
    */
   private <R, S> Pair<NavigableMap<byte[], List<S>>, List<S>> getMedianArgs(final byte[] tableName,
    ...
    * @throws Throwable
    */
   public <R, S> R median(final byte[] tableName, ColumnInterpreter<R, S> ci, Scan scan) throws Throwable {
