...
public class ChecksumFactory {
    ...
    */
   static public Constructor<?> newConstructor(String className) throws IOException {
      try {
         Class<?> clazz = getClassByName(className);
    ...
    */
   static private Class<?> getClassByName(String name) throws ClassNotFoundException {
