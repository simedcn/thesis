...
public class BlockCacheKey implements HeapSize {
   ...
   public BlockCacheKey(String file, long offset, DataBlockEncoding encoding, BlockType blockType) {
      ...
      this.encoding = (blockType == null || blockType.isData()) ? encoding : DataBlockEncoding.NONE;
   }
   ...
   @Override
   public int hashCode() {
      return hfileName.hashCode() * 127 + (int) (offset ^ (offset >>> 32)) + encoding.ordinal() * 17;
   }
   ...
   public String toString() {
      return hfileName + "_" + offset + (encoding == DataBlockEncoding.NONE ? "" : "_" + encoding);
   }
   ...
   public long heapSize() {
      return ClassSize.align(ClassSize.OBJECT + 2 * hfileName.length() + Bytes.SIZEOF_LONG + 2 * ClassSize.REFERENCE);
   }
