...
public class SplitRegionHandler extends EventHandler implements TotesHRegionInfo {
   ...
   public SplitRegionHandler(Server server, AssignmentManager assignmentManager, HRegionInfo regionInfo, ServerName sn,
         final List<HRegionInfo> daughters) {
   ...
   public void process() {
      ...
      try {
         ...
         while (!successful) {
            ...
            successful = ZKAssign.deleteNode(this.server.getZooKeeper(), encodedRegionName,
      ...
      LOG.info("Handled SPLIT event; parent=" + this.parent.getRegionNameAsString() + " daughter a="
            + this.daughters.get(0).getRegionNameAsString() + "daughter b="
