...
public class CloseMetaHandler extends CloseRegionHandler {
   ...
   public CloseMetaHandler(final Server server, final RegionServerServices rsServices, final HRegionInfo regionInfo) {
   ...
   public CloseMetaHandler(final Server server, final RegionServerServices rsServices, final HRegionInfo regionInfo,
      ...
      super(server, rsServices, regionInfo, abort, zk, versionOfClosingNode, EventType.M_RS_CLOSE_META);
   }
}
