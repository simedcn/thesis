...
public enum BlockType {
   ...
   public static BlockType parse(byte[] buf, int offset, int length) throws IOException {
      ...
      throw new IOException("Invalid HFile block magic: " + Bytes.toStringBinary(buf, offset, MAGIC_LENGTH));
   }
   ...
   public static BlockType read(ByteBuffer buf) throws IOException {
      BlockType blockType = parse(buf.array(), buf.arrayOffset() + buf.position(),
