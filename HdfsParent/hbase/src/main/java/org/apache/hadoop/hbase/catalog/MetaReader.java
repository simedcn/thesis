...
public class MetaReader {
    ...
    * @throws IOException
    */
   public static Map<HRegionInfo, ServerName> fullScan(CatalogTracker catalogTracker, final Set<String> disabledTables)
         throws IOException {
    ...
    * @throws IOException
    */
   public static void fullScan(CatalogTracker catalogTracker, final Visitor visitor) throws IOException {
    ...
    * @throws IOException
    */
   public static void fullScan(CatalogTracker catalogTracker, final Visitor visitor, final byte[] startrow)
         throws IOException {
    ...
    * @throws IOException
    */
   private static HTable getHTable(final CatalogTracker catalogTracker, final byte[] tableName) throws IOException {
    ...
    * @throws IOException
    */
   static HTable getCatalogHTable(final CatalogTracker catalogTracker, final byte[] row) throws IOException {
      return isRootTableRow(row) ? getRootHTable(catalogTracker) : getMetaHTable(catalogTracker);
   }
    ...
    * @throws IOException
    */
   static HTable getMetaHTable(final CatalogTracker ct) throws IOException {
    ...
    * @throws IOException
    */
   static HTable getRootHTable(final CatalogTracker ct) throws IOException {
   ...
   public static ServerName readMetaLocation(HRegionInterface metaServer) throws IOException {
      return readLocation(metaServer, CatalogTracker.ROOT_REGION_NAME, CatalogTracker.META_REGION_NAME);
   }
    ...
    * @throws IOException
    */
   static ServerName getMetaRegionLocation(final CatalogTracker ct) throws IOException {
   ...
   private static ServerName readLocation(HRegionInterface metaServer, byte[] catalogRegionName, byte[] regionName)
         throws IOException {
      Result r = null;
      try {
         r = metaServer.get(
               catalogRegionName,
               new Get(regionName).addColumn(HConstants.CATALOG_FAMILY, HConstants.SERVER_QUALIFIER).addColumn(
         ...
         if (e.getCause() != null && e.getCause() instanceof IOException && e.getCause().getMessage() != null
    ...
    * @throws IOException
    */
   public static Pair<HRegionInfo, ServerName> getRegion(CatalogTracker catalogTracker, byte[] regionName)
         throws IOException {
    ...
    * @throws IOException
    */
   public static Pair<HRegionInfo, ServerName> parseCatalogResult(final Result r) throws IOException {
      HRegionInfo info = parseHRegionInfoFromCatalogResult(r, HConstants.REGIONINFO_QUALIFIER);
    ...
    * @throws IOException
    */
   public static HRegionInfo parseHRegionInfoFromCatalogResult(final Result r, byte[] qualifier) throws IOException {
   ...
   public static boolean tableExists(CatalogTracker catalogTracker, String tableName) throws IOException {
      ...
      CollectingVisitor<HRegionInfo> visitor = new CollectingVisitor<HRegionInfo>() {
         ...
         public boolean visit(Result r) throws IOException {
            ...
            if (!isInsideTable(this.current, tableNameBytes))
               return false;
    ...
    * @throws IOException
    */
   public static List<HRegionInfo> getTableRegions(CatalogTracker catalogTracker, byte[] tableName,
         final boolean excludeOfflinedSplitParents) throws IOException {
   ...
   public static List<Pair<HRegionInfo, ServerName>> getTableRegionsAndLocations(CatalogTracker catalogTracker,
      ...
      return getTableRegionsAndLocations(catalogTracker, Bytes.toBytes(tableName), true);
   }
    ...
    * @throws InterruptedException
    */
   public static List<Pair<HRegionInfo, ServerName>> getTableRegionsAndLocations(final CatalogTracker catalogTracker,
         final byte[] tableName, final boolean excludeOfflinedSplitParents) throws IOException, InterruptedException {
      ...
      CollectingVisitor<Pair<HRegionInfo, ServerName>> visitor = new CollectingVisitor<Pair<HRegionInfo, ServerName>>() {
         ...
         public boolean visit(Result r) throws IOException {
            ...
            if (!isInsideTable(hri, tableName))
               return false;
            if (excludeOfflinedSplitParents && hri.isSplitParent())
               return true;
            ServerName sn = getServerNameFromCatalogResult(r);
   ...
   public static void fullScanMetaAndPrint(final CatalogTracker catalogTracker) throws IOException {
      Visitor v = new Visitor() {
         @Override
         public boolean visit(Result r) throws IOException {
            if (r == null || r.isEmpty())
    ...
    * @deprecated Does not retry; use fullScan xxx instead.
    x
    */
   public static void fullScan(HRegionInterface hRegionInterface, Visitor visitor, final byte[] regionName,
    ...
    * @throws IOException
    */
   static void fullScan(CatalogTracker catalogTracker, final Visitor visitor, final byte[] startrow,
         final boolean scanRoot) throws IOException {
      Scan scan = new Scan();
      if (startrow != null)
         scan.setStartRow(startrow);
