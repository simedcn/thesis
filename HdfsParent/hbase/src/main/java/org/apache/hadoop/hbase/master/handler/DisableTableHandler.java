...
public class DisableTableHandler extends EventHandler {
   ...
   public DisableTableHandler(Server server, byte[] tableName, CatalogTracker catalogTracker,
      ...
      if (!skipTableStateCheck) {
         try {
            ...
            throw new IOException(
                  "Unable to ensure that the table will be" + " disabling because of a ZooKeeper issue", e);
         }
      }
   }
