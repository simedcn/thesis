...
public class HBaseInfo {
   ...
   // HBase jar info
   private MetricsString date = new MetricsString("date", registry, org.apache.hadoop.hbase.util.VersionInfo.getDate());

   private MetricsString revision = new MetricsString("revision", registry,
         org.apache.hadoop.hbase.util.VersionInfo.getRevision());

   private MetricsString url = new MetricsString("url", registry, org.apache.hadoop.hbase.util.VersionInfo.getUrl());

   private MetricsString user = new MetricsString("user", registry, org.apache.hadoop.hbase.util.VersionInfo.getUser());
   ...
   private MetricsString hdfsUrl = new MetricsString("hdfsUrl", registry, org.apache.hadoop.util.VersionInfo.getUrl());
