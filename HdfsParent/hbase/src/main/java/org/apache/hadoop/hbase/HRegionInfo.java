...
public class HRegionInfo extends VersionedWritable implements WritableComparable<HRegionInfo> {
   ...
   private HRegionInfo(long regionId, byte[] tableName) {
      ...
      this.regionName = createRegionName(tableName, null, regionId, false);
    ...
    * @throws IllegalArgumentException
    */
   public HRegionInfo(final byte[] tableName, final byte[] startKey, final byte[] endKey, final boolean split)
         throws IllegalArgumentException {
   ...
   public HTableDescriptor getTableDesc() {
      ...
      FSTableDescriptors fstd = new FSTableDescriptors(fs, new Path(c.get(HConstants.HBASE_DIR)));
      try {
   ...
   public String toString() {
      return "{" + HConstants.NAME + " => '" + this.regionNameStr + "', STARTKEY => '"
