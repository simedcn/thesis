...
public class TimeToLiveHFileCleaner extends BaseHFileCleanerDelegate {
   ...
   public boolean isFileDeletable(Path filePath) {
      ...
      if (life < 0) {
         LOG.warn("Found a log (" + filePath + ") newer than current time (" + currentTime + " < " + time
