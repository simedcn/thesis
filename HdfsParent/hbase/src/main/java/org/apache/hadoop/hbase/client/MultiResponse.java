...
public class MultiResponse implements Writable {
   ...
   // Result)
   private Map<byte[], List<Pair<Integer, Object>>> results = new TreeMap<byte[], List<Pair<Integer, Object>>>(
         ...
         for (Pair<Integer, Object> r : lst) {
            if (r == null) {
               ...
               if (obj instanceof Throwable) {
                  ...
                  HbaseObjectWritable.writeObject(out, r.getSecond(), obj != null ? obj.getClass() : Writable.class,
                        null);
               }
            }
         }
