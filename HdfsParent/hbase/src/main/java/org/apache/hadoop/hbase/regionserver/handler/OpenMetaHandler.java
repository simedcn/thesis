...
public class OpenMetaHandler extends OpenRegionHandler {
   public OpenMetaHandler(final Server server, final RegionServerServices rsServices, HRegionInfo regionInfo,
   ...
   public OpenMetaHandler(final Server server, final RegionServerServices rsServices, HRegionInfo regionInfo,
      ...
      super(server, rsServices, regionInfo, htd, EventType.M_RS_OPEN_META, versionOfOfflineNode);
   }
}