...
public class ColumnSchemaModel implements Serializable {
   ...
   public boolean __getBlockcache() {
      ...
      return o != null ? Boolean.valueOf(o.toString()) : HColumnDescriptor.DEFAULT_BLOCKCACHE;
   }
   ...
   public int __getBlocksize() {
      ...
      return o != null ? Integer.valueOf(o.toString()) : HColumnDescriptor.DEFAULT_BLOCKSIZE;
   }
   ...
   public boolean __getInMemory() {
      ...
      return o != null ? Boolean.valueOf(o.toString()) : HColumnDescriptor.DEFAULT_IN_MEMORY;
   }
   ...
   public int __getTTL() {
      ...
      return o != null ? Integer.valueOf(o.toString()) : HColumnDescriptor.DEFAULT_TTL;
   }
   ...
   public int __getVersions() {
      ...
      return o != null ? Integer.valueOf(o.toString()) : HColumnDescriptor.DEFAULT_VERSIONS;
   }
