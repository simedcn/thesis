...
public class ReplicationSourceManager {
    ...
    */
   public ReplicationSourceManager(final ReplicationZookeeper zkHelper, final Configuration conf,
         final Stoppable stopper, final FileSystem fs, final AtomicBoolean replicating, final Path logDir,
    ...
    * @throws IOException
    */
   public ReplicationSourceInterface getReplicationSource(final Configuration conf, final FileSystem fs,
         final ReplicationSourceManager manager, final Stoppable stopper, final AtomicBoolean replicating,
   ...
   public void removePeer(String id) {
      LOG.info("Closing the following queue " + id + ", currently have " + sources.size() + " and another "
   ...
   class NodeFailoverWorker extends Thread {
      ...
      public void run() {
         ...
         for (Map.Entry<String, SortedSet<String>> entry : newQueues.entrySet()) {
            ...
            try {
               ReplicationSourceInterface src = getReplicationSource(conf, fs, ReplicationSourceManager.this, stopper,
                     replicating, peerId);
