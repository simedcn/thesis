...
public class MetricsHistogram extends MetricsBase {
    ...
    */
   public MetricsHistogram(final String nam, final MetricsRegistry registry, final String description,
      ...
      this.sample = forwardBiased ? new ExponentiallyDecayingSample(DEFAULT_SAMPLE_SIZE, DEFAULT_ALPHA)
    ...
    * @param description the metric's description
    */
   public MetricsHistogram(final String nam, MetricsRegistry registry, final String description) {
   ...
   public void pushMetric(MetricsRecord mr) {
      ...
      mr.setMetric(getName() + SEVENTY_FIFTH_PERCENTILE_METRIC_NAME, (float) s.get75thPercentile());
      mr.setMetric(getName() + NINETY_FIFTH_PERCENTILE_METRIC_NAME, (float) s.get95thPercentile());
      mr.setMetric(getName() + NINETY_NINETH_PERCENTILE_METRIC_NAME, (float) s.get99thPercentile());
   }
}
