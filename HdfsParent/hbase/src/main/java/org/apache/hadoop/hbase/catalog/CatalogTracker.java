...
public class CatalogTracker {
    ...
    * @throws IOException 
    */
   public CatalogTracker(final ZooKeeperWatcher zk, final Configuration conf, final Abortable abortable)
         throws IOException {
    ...
    * @throws IOException
    */
   public CatalogTracker(final ZooKeeperWatcher zk, final Configuration conf, Abortable abortable,
    ...
    * @throws IOException
    */
   HRegionInterface getRootServerConnection(long timeout) throws InterruptedException,
         NotAllMetaRegionsOnlineException, IOException {
    ...
    * timeout
    */
   public ServerName waitForMeta(long timeout) throws InterruptedException, IOException,
   ...
   private boolean verifyRegionLocation(HRegionInterface hostingServer, final ServerName address,
   ...
   public boolean verifyRootRegionLocation(final long timeout) throws InterruptedException, IOException {
      ...
      return (connection == null) ? false : verifyRegionLocation(connection,
