...
public class HLogKey implements WritableComparable<HLogKey> {
   ...
   public HLogKey() {
      this(null, null, 0L, HConstants.LATEST_TIMESTAMP, HConstants.DEFAULT_CLUSTER_ID);
   }
    ...
    */
   public HLogKey(final byte[] encodedRegionName, final byte[] tablename, long logSeqNum, final long now, UUID clusterId) {
   ...
   public String toString() {
      return Bytes.toString(tablename) + "/" + Bytes.toString(encodedRegionName) + "/" + logSeqNum;
   }
   ...
   public void write(DataOutput out) throws IOException {
      ...
      if (compressionContext == null) {
         ...
         Compressor.writeCompressed(this.tablename, 0, this.tablename.length, out, compressionContext.tableDict);
      }
