...
public class HQuorumPeer {
   ...
   public static void main(String[] args) {
      ...
      try {
         ...
         ZKUtil.loginServer(conf, "hbase.zookeeper.server.keytab.file", "hbase.zookeeper.server.kerberos.principal",
   ...
   static void writeMyID(Properties properties) throws IOException {
      ...
      Configuration conf = HBaseConfiguration.create();
      String myAddress = Strings
            .domainNamePointerToHostName(DNS.getDefaultHost(conf.get("hbase.zookeeper.dns.interface", "default"),
