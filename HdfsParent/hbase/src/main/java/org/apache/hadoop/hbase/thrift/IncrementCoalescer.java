...
public class IncrementCoalescer implements IncrementCoalescerMBean {
   ...
   private final ConcurrentMap<FullyQualifiedRow, Long> countersMap = new ConcurrentHashMap<FullyQualifiedRow, Long>(
         100000, 0.75f, 1500);
   ...
   private boolean internalQueueTincrement(TIncrement inc) throws TException {
      ...
      return internalQueueIncrement(inc.getTable(), inc.getRow(), famAndQf[0], qual, inc.getAmmount());
