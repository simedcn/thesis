...
public class MetaServerShutdownHandler extends ServerShutdownHandler {
   ...
   public MetaServerShutdownHandler(final Server server, final MasterServices services, final DeadServer deadServers,
         final ServerName serverName, final boolean carryingRoot, final boolean carryingMeta) {
