...
public interface HRegionInterface extends VersionedProtocol, Stoppable, Abortable {
    ...
    */
   public HRegionInfo getRegionInfo(final byte[] regionName) throws NotServingRegionException, ConnectException,
         IOException;
    ...
    * @throws IOException e
    */
   public long lockRow(final byte[] regionName, final byte[] row) throws IOException;
    ...
    * @throws IOException e
    */
   public void unlockRow(final byte[] regionName, final long lockId) throws IOException;
    ...
    * @throws IOException
    */
   public boolean closeRegion(final HRegionInfo region, final boolean zk) throws IOException;
    ...
    * @throws IOException
    */
   public boolean closeRegion(byte[] encodedRegionName, final boolean zk) throws IOException;
    ...
    * @throws IOException
    */
   void compactRegion(HRegionInfo regionInfo, boolean major, byte[] columnFamily) throws NotServingRegionException,
         IOException;
