...
public class ProtocolSignature implements Writable {
    ...
    */
   final private static HashMap<String, ProtocolSigFingerprint> PROTOCOL_FINGERPRINT_CACHE = new HashMap<String, ProtocolSigFingerprint>();
    ...
    */
   private static ProtocolSigFingerprint getSigFingerprint(Class<? extends VersionedProtocol> protocol,
         long serverVersion) {
    ...
    */
   static ProtocolSignature getProtocolSignature(int clientMethodsHashCode, long serverVersion,
