...
public class TFile {
   ...
   public static class Writer implements Closeable {
       ...
       */
      public DataOutputStream prepareMetaBlock(String name, String compressName) throws IOException,
   ...
   public static class Reader implements Closeable {
      ...
      public static class Scanner implements Closeable {
         ...
         protected Scanner(Reader reader, RawComparable beginKey, RawComparable endKey) throws IOException {
            this(reader, (beginKey == null) ? reader.begin() : reader.getBlockContainsKey(beginKey, false), reader
                  .end());
            if (beginKey != null) {
      ...
      static BytesComparator makeComparator(String comparator) {
         ...
         if (comparator.equals(COMPARATOR_MEMCMP)) {
            ...
            try {
               ...
               throw new IllegalArgumentException("Failed to instantiate comparator: " + comparator + "("
                     + e.toString() + ")");
            }
         } else {
