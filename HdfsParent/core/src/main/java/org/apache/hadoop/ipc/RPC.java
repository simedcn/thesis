...
public class RPC {
   ...
   private static class Invoker implements InvocationHandler {
      ...
      public Invoker(Class<? extends VersionedProtocol> protocol, InetSocketAddress address,
    ...
    * talking to a server at the named address. */
   public static VersionedProtocol getProxy(Class<? extends VersionedProtocol> protocol, long clientVersion,
         InetSocketAddress addr, UserGroupInformation ticket, Configuration conf, SocketFactory factory, int rpcTimeout)
         throws IOException {
