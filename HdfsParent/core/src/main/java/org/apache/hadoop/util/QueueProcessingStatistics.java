...
public abstract class QueueProcessingStatistics {
    ...
    */
   public enum State {
      BEGIN_COLLECTING, IN_FIRST_CYCLE, IN_SOLE_CYCLE, DONE_FIRST_CYCLE, IN_LAST_CYCLE, DONE_COLLECTING,
   }
   ...
   public void startCycle(int maxWorkToProcess) {
      ...
      if (state == State.DONE_COLLECTING)
         return;
   ...
   String msgEndFirstCycle() {
      return queueName + " QueueProcessingStatistics: First cycle completed " + workItemCount + " " + workItemsName
            + " in " + processDuration + " msec";
   }
   ...
   String msgEndLastCycle() {
      return queueName + " QueueProcessingStatistics: Queue flush completed " + workItemCount + " " + workItemsName
            + " in " + processDuration + " msec processing time, " + clockDuration + " msec clock time, " + cycleCount
            + " cycles";
   }
   ...
   String msgError(String msg) {
      return queueName + " QueueProcessingStatistics - Error: " + msg;
   }
   ...
   String msgErrorWithStats(String msg) {
      return queueName + " QueueProcessingStatistics - Error: " + msg + " Completed " + workItemCount + " "
            + workItemsName + " in " + processDuration + " msec processing time, " + clockDuration
            + " msec clock time, " + cycleCount + " cycles";
   }
