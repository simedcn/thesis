...
public class ShellBasedUnixGroupsNetgroupMapping extends ShellBasedUnixGroupsMapping {
    ...
    */
   private void getUnixGroups(final String user, List<String> groups) throws IOException {
   ...
   protected void getNetgroups(final String user, List<String> groups) throws IOException {
   ...
   protected String execShellGetUnixGroups(final String user) throws IOException {
      String result = "";
      try {
