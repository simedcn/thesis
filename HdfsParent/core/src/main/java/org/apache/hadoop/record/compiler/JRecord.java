...
public class JRecord extends JCompType {
   ...
   class JavaRecord extends JavaCompType {
      ...
      void genSetupRtiFields(CodeBuffer cb) {
         ...
         cb.append("org.apache.hadoop.record.meta.FieldTypeInfo " + Consts.RIO_PREFIX + "tInfo = " + Consts.RIO_PREFIX
               + "it.next();\n");
      ...
      void genCode(String destDir, ArrayList<String> options) throws IOException {
         ...
         if (0 != ct) {
            ...
            cb.append("java.util.ArrayList<" + "org.apache.hadoop.record.meta.FieldTypeInfo> typeInfos = "
                  + "(java.util.ArrayList<" + "org.apache.hadoop.record.meta.FieldTypeInfo>)" + "(" + Consts.RTI_FILTER
                  + ".getFieldTypeInfos());\n");
            cb.append("org.apache.hadoop.record.meta.Utils.skip(" + Consts.RECORD_INPUT + ", " + "typeInfos.get("
                  + Consts.RIO_PREFIX + "i).getFieldID(), typeInfos.get(" + Consts.RIO_PREFIX + "i).getTypeID());\n");
            cb.append("}\n");
         }
         cb.append("}\n");
         cb.append(Consts.RECORD_INPUT + ".endRecord(" + Consts.TAG + ");\n");
   ...
   class CppRecord extends CppCompType {
      ...
      void genCode(FileWriter hh, FileWriter cc, ArrayList<String> options) throws IOException {
         ...
         hb.append("virtual void serialize(::hadoop::OArchive& " + Consts.RECORD_OUTPUT + ", const char* " + Consts.TAG
               + ") const;\n");
