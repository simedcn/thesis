...
public class JMap extends JCompType {
   ...
   class JavaMap extends JavaCompType {
      ...
      void genCompareTo(CodeBuffer cb, String fname, String other) {
         ...
         cb.append(key.getType() + " " + getId(Consts.RIO_PREFIX + "k1") + " = " + getId(Consts.RIO_PREFIX + "miter1")
               + ".next();\n");
         cb.append(key.getType() + " " + getId(Consts.RIO_PREFIX + "k2") + " = " + getId(Consts.RIO_PREFIX + "miter2")
               + ".next();\n");
      ...
      void genReadMethod(CodeBuffer cb, String fname, String tag, boolean decl) {
         ...
         cb.append("{\n");
         incrLevel();
         cb.append("org.apache.hadoop.record.Index " + getId(Consts.RIO_PREFIX + "midx") + " = " + Consts.RECORD_INPUT
               + ".startMap(\"" + tag + "\");\n");
      ...
      void genSlurpBytes(CodeBuffer cb, String b, String s, String l) {
         ...
         cb.append("for (int " + getId("midx") + " = 0; " + getId("midx") + " < " + getId("mi") + "; " + getId("midx")
               + "++) {");
