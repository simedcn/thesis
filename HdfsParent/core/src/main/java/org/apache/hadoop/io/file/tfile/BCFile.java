...
final class BCFile {
   ...
   static public class Writer implements Closeable {
      ...
      private BlockAppender prepareMetaBlock(String name, Algorithm compressAlgo) throws IOException,
       ...
       */
      public BlockAppender prepareMetaBlock(String name, String compressionName) throws IOException,
            MetaBlockAlreadyExists {
   ...
   static public class Reader implements Closeable {
      ...
      static private final class RBlockState {
         ...
         public RBlockState(Algorithm compressionAlgo, FSDataInputStream fsin, BlockRegion region, Configuration conf)
               throws IOException {
            this.compressAlgo = compressionAlgo;
            this.region = region;
            ...
            try {
               this.in = compressAlgo.createDecompressionStream(
                     new BoundedRangeFileInputStream(fsin, this.region.getOffset(), this.region.getCompressedSize()),
      ...
      public BlockReader getDataBlock(int blockIndex) throws IOException {
         if (blockIndex < 0 || blockIndex >= getBlockCount()) {
            throw new IndexOutOfBoundsException(String.format("blockIndex=%d, numBlocks=%d", blockIndex,
                  getBlockCount()));
         }
   ...
   static final class Magic {
      private final static byte[] AB_MAGIC_BCFILE = {
            ...
            (byte) 0x39, (byte) 0xdf, (byte) 0x41, (byte) 0x40, (byte) 0x92, (byte) 0xba, (byte) 0xe1, (byte) 0x50 };
