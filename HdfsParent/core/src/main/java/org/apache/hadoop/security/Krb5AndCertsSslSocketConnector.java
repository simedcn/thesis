...
public class Krb5AndCertsSslSocketConnector extends SslSocketConnector {
   public static final List<String> KRB5_CIPHER_SUITES = Collections.unmodifiableList(Collections
         .singletonList("TLS_KRB5_WITH_3DES_EDE_CBC_SHA"));
   static {
   ...
   protected SSLServerSocketFactory createFactory() throws Exception {
      ...
      SSLContext context = super.getProvider() == null ? SSLContext.getInstance(super.getProtocol()) : SSLContext
            .getInstance(super.getProtocol(), super.getProvider());
   ...
   protected ServerSocket newServerSocket(String host, int port, int backlog) throws IOException {
      ...
      if (useCerts) // Get the server socket from the SSL super impl
         ...
         try {
            ss = (SSLServerSocket) (host == null ? createFactory().createServerSocket(port, backlog) : createFactory()
