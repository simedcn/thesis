   ...
   private void createMBeanInfo() {
      ...
      for (MetricsBase o : metricsRegistry.getMetricsList()) {
         ...
         if (MetricsTimeVaryingRate.class.isInstance(o)) {
            ...
            attributesInfo.add(new MBeanAttributeInfo(o.getName() + NUM_OPS, "java.lang.Integer", o.getDescription(),
                  true, false, false));
            ...
            attributesInfo.add(new MBeanAttributeInfo(o.getName(), "java.lang.Long", o.getDescription(), true, false,
                  false));
         } else {
