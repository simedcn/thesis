...
public class JVector extends JCompType {
   ...
   class JavaVector extends JavaCompType {
      ...
      void genReadMethod(CodeBuffer cb, String fname, String tag, boolean decl) {
         ...
         cb.append("{\n");
         incrLevel();
         cb.append("org.apache.hadoop.record.Index " + getId(Consts.RIO_PREFIX + "vidx") + " = " + Consts.RECORD_INPUT
               + ".startVector(\"" + tag + "\");\n");
      ...
      void genSlurpBytes(CodeBuffer cb, String b, String s, String l) {
         ...
         cb.append("for (int " + getId("vidx") + " = 0; " + getId("vidx") + " < " + getId("vi") + "; " + getId("vidx")
               + "++)");
