...
public class ProcessTree {
   ...
   public static void killProcess(String pid, Signal signal) {
      ...
      try {
         ...
         LOG.warn("Error sending signal " + signal + " to process " + pid + " ." + StringUtils.stringifyException(e));
      } finally {
         LOG.info("Killing process " + pid + " with signal " + signal + ". Exit code " + shexec.getExitCode());
      }
   }
   ...
   public static void killProcessGroup(String pgrpId, Signal signal) {
      ...
      try {
         ...
         LOG.warn("Error sending signal " + signal + " to process group " + pgrpId + " ."
               + StringUtils.stringifyException(e));
      } finally {
         LOG.info("Killing process group" + pgrpId + " with signal " + signal + ". Exit code " + shexec.getExitCode());
      }
   }
