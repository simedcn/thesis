 ...
 */
  ...
  private boolean isReplicationInProgress(DatanodeDescriptor srcNode) {
    ...
    srcNode.getDecommissioningStatus().set(underReplicatedBlocks,
  ...
  public String getDecomNodes() {
    ...
    for (DatanodeDescriptor node : decomNodeList) {
      final Map<String, Object> innerinfo = new HashMap<String, Object>();
      innerinfo.put("underReplicatedBlocks", node.getDecommissioningStatus()
          .getUnderReplicatedBlocks());
      innerinfo.put("decommissionOnlyReplicas", node.getDecommissioningStatus()
          .getDecommissionOnlyReplicas());
      innerinfo.put("underReplicateInOpenFiles", node.getDecommissioningStatus()
