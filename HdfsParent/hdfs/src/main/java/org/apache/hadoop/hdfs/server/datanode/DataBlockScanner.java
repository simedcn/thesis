...
class DataBlockScanner implements Runnable {
   ...
   synchronized void printBlockReport(StringBuilder buffer, boolean summaryOnly) {
      ...
      double pctProgress = (totalBytesToScan == 0) ? 100 : (totalBytesToScan - bytesLeft) * 10000.0 / totalBytesToScan
      ...
      buffer.append(String.format("\nTotal Blocks                 : %6d" + "\nVerified in last hour        : %6d"
            ...
            inOneHour, inOneDay, inOneWeek, inFourWeeks, inScanPeriod, neverScanned, totalVerifications, totalScans,
            totalScanErrors, totalTransientErrors, Math.round(throttler.getBandwidth() / 1024.0), pctProgress,
            pctPeriodLeft));
   }
   ...
   public static class Servlet extends HttpServlet {
      ...
      public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
         ...
         DataBlockScanner blockScanner = (DataBlockScanner) getServletContext().getAttribute("datanode.blockScanner");
