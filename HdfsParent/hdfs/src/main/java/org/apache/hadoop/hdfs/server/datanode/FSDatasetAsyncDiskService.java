...
class FSDatasetAsyncDiskService {
   ...
   static class ReplicaFileDeleteTask implements Runnable {
      ...
      public String toString() {
         ...
         return "deletion of block " + blockName + " with block file " + blockFile + " and meta file " + metaFile
               + " from volume " + volume;
      }
      ...
      public void run() {
         if (!blockFile.delete() || (!metaFile.delete() && metaFile.exists())) {
            DataNode.LOG.warn("Unexpected error trying to delete block " + blockName + " at file " + blockFile
                  + ". Ignored.");
         } else {
