...
public class DelegationTokenSelector extends AbstractDelegationTokenSelector<DelegationTokenIdentifier> {
   ...
   public static Token<DelegationTokenIdentifier> selectHdfsDelegationToken(final InetSocketAddress nnAddr,
      ...
      final Text serviceName = SecurityUtil.buildTokenService(NetUtils.makeSocketAddr(nnAddr.getHostName(), nnRpcPort));
