...
public class RegionFlusherTest extends BaseFileStorageTest {
	...
	public void init() throws IOException {
		...
		region = new Region(0, null, null, null);
	}
	...
	public void testRun() {
		...
		try {
			...
			// TODO
			RegionFlusher flusher = new RegionFlusher(null, null, new IRegionFlushListener() {
				@Override
						...
						while (it.hasNext()) {
							...
							if (i != 0) {
								if (i % 4 == 0) {
									...
									assertArrayEquals(new byte[] { (byte) (i) }, kv.getValue()
											.getValue());
								}
							}
							i += 2;
			...
			flusher = new RegionFlusher(null, null, new IRegionFlushListener() {
