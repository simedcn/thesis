 ...
 * 
 */
public class KVFSInputIterator implements Iterator<KeyValue> {
	...
	private static Logger logger = LoggerFactory.getLogger(KVFSInputIterator.class);

	public KVFSInputIterator(int start, int end, int blockSize, int offset, InputStream in)
			throws IOException {
		super();
